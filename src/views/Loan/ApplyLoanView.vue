...
>>>>>>> Stashed changes
    ...
    <!-- 申请贷款的弹出层 -->
    <el-dialog v-model="Propsform.dialogFormVisible" 
    title="申请贷款"
     width="400"
    ...
    >
      ...
      <div class="xieyi">
        ...
        <p>
            同意之后选中<a class="xie_butt" href="JavaScript:;" @click="Propsform.user_index='1';Propsform.isShow=true">《用户协议》</a>
             与<a class="xie_butt" href="javaScript:;" @click="Propsform.user_index ='2';Propsform.isShow=true">《隐私政策》</a>
        </p>
      </div>
...
<!-- 用户协议和隐私政策 弹出层 -->
<el-dialog v-model="Propsform.isShow" 
     width="864"
    :before-close="handleClose"
    :center="true"
